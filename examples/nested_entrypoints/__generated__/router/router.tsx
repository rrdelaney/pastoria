 ...
 * @generated-checksum 2e81dd2ed4a990b0f438829374e2b4bf687c5b29f6ba10e3df235bb02d6a4aa1
...
import {
  schema as search_EP_schema,
  entrypoint as search_EP_entrypoint,
  Queries as search_EP_Queries,
  EntryPoints as search_EP_EntryPoints,
  type PreloadPropParams as search_EP_PreloadPropParams,
} from './search_page.entrypoint';
import {
  schema as hello_$name_EP_schema,
  entrypoint as hello_$name_EP_entrypoint,
  Queries as hello_$name_EP_Queries,
  EntryPoints as hello_$name_EP_EntryPoints,
  type PreloadPropParams as hello_$name_EP_PreloadPropParams,
...
const ROUTER_CONF = {
  ...
  '/search': {
    entrypoint: search_EP_entrypoint,
    schema: search_EP_schema,
  } as const,
  '/hello/[name]': {
    entrypoint: hello_$name_EP_entrypoint,
    schema: hello_$name_EP_schema,
  } as const,
} as const;
...
declare global {
  type PastoriaRouteName = '/search' | '/hello/[name]';

  type PastoriaPageQueries = {
    ['/search']: search_EP_Queries;
    ['/hello/[name]']: hello_$name_EP_Queries;
  };

  type PastoriaPageEntryPoints = {
    ['/search']: search_EP_EntryPoints;
    ['/hello/[name]']: hello_$name_EP_EntryPoints;
  };
  ...
  type PastoriaPreloadPropsParams = {
    ['/search']: search_EP_PreloadPropParams;
    ['/hello/[name]']: hello_$name_EP_PreloadPropParams;
  };

  type GetPreloadProps<R extends PastoriaRouteName> = (
    params: PastoriaPreloadPropsParams[R],
  ) => PreloadProps<
    z.output<RouterConf[R]['schema']>,
