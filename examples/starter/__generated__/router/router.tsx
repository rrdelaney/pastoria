 ...
 * @generated-checksum 46c31cad5ac568fd547d7bf59fecf73f47af8d125c7a4df4351a7eb0aab0d092
...
import { schema as cool_EP_schema, entrypoint as cool_EP_entrypoint, Queries as cool_EP_Queries, EntryPoints as cool_EP_EntryPoints } from "./cool.entrypoint";
...
const ROUTER_CONF = {
  ...
  "/cool": {
      entrypoint: cool_EP_entrypoint,
      schema: cool_EP_schema,
    } as const
} as const;
...
declare global {
  ...
  type PastoriaPageQueries = {
    ['/cool']: cool_EP_Queries,
  };

  type PastoriaPageEntryPoints = {
    ['/cool']: cool_EP_EntryPoints,
  };
